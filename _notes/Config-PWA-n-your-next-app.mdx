...
excerpt: 'notes about how to config your manfist and your service workers'
date: '20/12/2021'
featured: false
bgColor: 'yellow'
---
...
- <Tag>scope</Tag>: The "scope" property defines the navigation scope of the web
  ...
  navigated to without leaving the app experience . like if you want to access
  singing with google it will open new tab like browser in your app
