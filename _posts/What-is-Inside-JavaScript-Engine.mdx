...
excerpt: 'Have you ever asked yourself what the hell is Engine, why we need it , why not  just write code and execute in the browser directly without an engine ,so  let me give you an example why we need it .'
coverImage: '/assets/blog/What-is-Inside-JavaScript-Engine/cover.png'
date: '20/09/2021'
featured: true
author:
  name: Wassim Nassour
...
ogImage:
  url: '/assets/blog/What-is-Inside-JavaScript-Engine/cover.png'
  thumbnail: /assets/blog/What-is-Inside-JavaScript-Engine/cover.png
---
...
<Img
  height={70}
  src={'/assets/blog/What-is-Inside-JavaScript-Engine/cover.png'}
/>
...
<CodeBlock>const happy = true</CodeBlock>
...
<Img
  ...
  objectFit="contain"
  class="gif"
  src={'https://media.giphy.com/media/26BkNYAuK4IRbgP6M/source.gif'}
/>
...
<Img
  ...
  width="100%"
  src={
    'https://lh6.googleusercontent.com/qBZYtzXJkidftdgs1r9YIZ6Aft_qZDd_SZCX8zFIo958_eL3XtPGfwU6Ki9hG6FVr9eeWSez7BqPIMgKUc6dBxRrmc6iU6m-uEAfWqBwzJvLgQxi3iHxDQunXbQfhMZbO3iPUyu4'
  }
/>

The first thing that happens within the JavaScript engine is parsing of our code
by parser. A parser basically reads our code line by line and checks it for errors
and stops execution if any, if the code is free of syntactic errors, the parser produces
a data structure called abstract syntax tree, which is then translated to machine
code and thus results in output.
